add_custom_command(TARGET PlatonLLVM POST_BUILD COMMAND mkdir -p ${CMAKE_BINARY_DIR}/bin)
macro(platon_llvm_install file)
  set(BINARY_DIR ${CMAKE_BINARY_DIR}/platon_llvm/bin)
  add_custom_command(TARGET PlatonLLVM POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy ${BINARY_DIR}/${file} ${CMAKE_BINARY_DIR}/bin/)
...
macro(platon_tools_install file)
  ...
  add_custom_command(TARGET PlatonTools POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy ${BINARY_DIR}/${file} ${CMAKE_BINARY_DIR}/bin/)
  install(FILES ${BINARY_DIR}/${file}
    DESTINATION ${CMAKE_INSTALL_FULL_BINDIR}
    PERMISSIONS OWNER_READ OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
