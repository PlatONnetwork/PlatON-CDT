...
//===----------------------------------------------------------------------===//
//
// This file is a configuration header for soft-float routines in compiler-builtins.
// This file does not provide any part of the compiler-builtins interface, but defines
// many useful constants and utility routines that are used in the
// implementation of the soft-float routines in compiler-builtins.
//
...
// pulling in a libm dependency from compiler-builtins, but is not meant to replace
