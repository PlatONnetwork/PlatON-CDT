...
void* malloc(size_t size)
{
   return platon::memory_heap.malloc(size);
}

void* calloc(size_t count, size_t size)
{
   void* ptr = platon::memory_heap.malloc(count*size);
...
void* realloc(void* ptr, size_t size)
{
   return platon::memory_heap.realloc(ptr, size);
}

void free(void* ptr)
{
   return platon::memory_heap.free(ptr);
}
