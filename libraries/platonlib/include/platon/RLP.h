...
namespace platon
{
    ...
    template <> struct intTraits<bigint> { static const unsigned maxSize = 64; };
 ...
 */
    ...
    template <> struct Converter<bool> { static bool convert(RLP const& _r, int _flags) { return _r.toBool(_flags); } };
